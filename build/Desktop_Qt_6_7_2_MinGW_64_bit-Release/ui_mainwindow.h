...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        SMUpcomingAssignmentsLabel->setGeometry(QRect(480, 110, 181, 21));
        QFont font;
        ...
        SMUpcomingAssignmentsList->setGeometry(QRect(480, 140, 281, 111));
        SMUpcomingTestsList = new QListWidget(studentMainPage);
        SMUpcomingTestsList->setObjectName("SMUpcomingTestsList");
        SMUpcomingTestsList->setGeometry(QRect(480, 370, 281, 111));
        label = new QLabel(studentMainPage);
        label->setObjectName("label");
        label->setGeometry(QRect(480, 340, 131, 21));
        label->setFont(font);
...
"", nullptr));
        ...
        label->setText(QCoreApplication::translate("MainWindow", "Upcoming Tests:", nullptr));
